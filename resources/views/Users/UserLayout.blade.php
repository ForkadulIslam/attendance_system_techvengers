...
<html lang="en">
<head>
    <title>TechVengers Attendance System</title>
...
<div class="navbar navbar-inverse">
    <div class="navbar-inner">
        <div class="container-fluid">
            ...
            <div class="btn-group pull-right" style="margin-top: 0.5%;margin-right: 1%;">
                <span class="label label-success">{{ Auth::user()->Designation->name }}</span>
            </div>
            @endif
        </div>
    </div>
        ...
        <div class="span2 main-menu-span">
            <div class="well nav-collapse sidebar-nav">
                <ul class="nav nav-tabs nav-stacked main-menu">
                    ...
                    <li><a class="ajax-link" href="{!! URL::to('user/notice-board') !!}"><i class="icon-list"></i><span class="hidden-tablet"> Notice Board</span></a></li>
