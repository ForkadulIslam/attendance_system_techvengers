...
@section('content')
    <div>
        <ul class="breadcrumb">
            ...
            <li>
                <a href="{!! URL::to('company/attendance-log') !!}?s_date=<?php echo $log->login_date ?>&e_date=<?php echo $log->login_date ?>&id=<?php echo $log->user_id ?>">Attendance Log</a>
            </li>
        </ul>
    </div>
    <div>
        <div class="row-fluid sortable">
            <div class="box span12">
                ...
                <div class="box-content">
                    {!! Form::open(array('id' => 'notice', 'accept-charset' => 'utf-8', 'class' => 'form-horizontal','url' => url('company/attendance-log-time-edit-request', $log->id), 'autocomplete'=>'off')) !!}
                    <fieldset>
