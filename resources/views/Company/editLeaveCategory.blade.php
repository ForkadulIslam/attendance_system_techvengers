                ...
                <table class="table table-striped table-bordered bootstrap-datatable datatable" ng-controller="deleteController">
                    ...
                    <tr class="list" id="row_<?php echo $category->id ?>">
                        ...
                        <td class="center">
                            ...
                            <a class="btn btn-info" href="{!! URL::to('company/edit-leave-category', $category->id) !!}" >
                    ...
                    <tr>
                        ...
                        <td colspan="2" style="text-align: left; font-weight: 700">{!! collect($allCategory)->sum('category_num') !!}</td>
                    </tr>
                    </tfoot>
                    </tbody>
                </table>
